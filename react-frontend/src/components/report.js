...
const Report = () => (
    <div>
        ...
        <p>När man googlar får man upp förslag på olika moduler som låter React fixa animationer, och det kan kanske vara en bra idé. Men i det stadiet jag är i nu, så vill jag gärna behärska kodandet på en lite mer grundläggande nivå. Jag känner att det är lätt att tappa översikten om man skulle ge efter och plocka in nya moduler för varje funktionalitet.</p>
        ...
        <p>Det är flera delar som ska passa samman, så det gäller at hålla tungan rätt i mun. När jag skulle föra över mongodb till klient/server-appen glömde jag detaljen att inkludera body-parser i app.js. body-parser är en middleware-modul som express använder för att hantera HTTP-POST-anrop på korrekt sätt. Middleware-moduler anropas alltså före varje route anropas. </p>
        <h3>Kmom06</h3>
        <h3>Kmom07-10</h3>
    </div>
);
